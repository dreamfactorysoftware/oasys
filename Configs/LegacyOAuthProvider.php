...
class LegacyOAuthProvider extends BaseProviderConfig
{
	 ...
	 * @var string
	 */
	const AUTHORIZE_ENDPOINT = 'auth';
	/**
	 * @var string
	 */
	const REQUEST_TOKEN_ENDPOINT = 'request';
	/**
	 * @var string
	 */
	const ACCESS_TOKEN_ENDPOINT = 'access';
	/**
	 * @var string
	 */
	...
	public function __construct( $contents = array() )
	{
		...
		{
			$this->mapEndpoint( static::AUTHORIZE_ENDPOINT, $_uri );
		}

		if ( null !== ( $_uri = Option::get( $contents, 'request_token_uri', null, true ) ) )
		{
			$this->mapEndpoint( static::REQUEST_TOKEN_ENDPOINT, $_uri );
		}

		if ( null !== ( $_uri = Option::get( $contents, 'access_token_uri', null, true ) ) )
		{
			$this->mapEndpoint( static::ACCESS_TOKEN_ENDPOINT, $_uri );
		}

		if ( null !== ( $_uri = Option::get( $contents, 'refresh_token_uri', null, true ) ) )
		{
			$this->mapEndpoint( static::REFRESH_TOKEN_ENDPOINT, $_uri );
		}
